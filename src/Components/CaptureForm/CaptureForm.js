...
const CaptureForm = () => {
    return (
        <div className={Styles.form}>
            <h2 className={Styles.subtitle}>Заполни форму и получи смету бесплатно</h2>
            ...
            <a href="#" className={Styles.button}>Получить смету<span className={Styles.flare}></span></a>
        </div>
    );
};
