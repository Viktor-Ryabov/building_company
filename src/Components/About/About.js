    ...
    return (
        <section className={Styles.main}>
            <article className={Styles.article}>
                ...
                <p className={Styles.text}>Соблюдаем сроки, следим за качеством работ и материалов.</p>
                <p className={Styles.text}>Советуем клиентам как сделать лучше.</p>
                <p className={Styles.text}>Предоставляем гарантию на выполненные работы.</p>
